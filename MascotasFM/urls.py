"""
URL configuration for MascotasFM project.
...
urlpatterns = [
    ...
    path('usuario/adoptante/', include('Aplicaciones.Usuario.AdoptanteU.urls')),
    path('usuario/adopcion/', include('Aplicaciones.Usuario.AdopcionU.urls')),
]
